...
func Test_Update(t *testing.T) {
	m := transform.NewUpdate(collector.NewCollector(keys.New([]string{_keyName}), mode.NewAll(), tag.NewMostKey(_rule)), nil)
...
func Test_Insert(t *testing.T) {
	...
	m := transform.NewInsert(collector.NewCollector(keys.New([]string{_keyName}), mode.NewAll(), tag.NewKey(_rule)), nil)
