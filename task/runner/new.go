...
func CleanTask(resource task.CleanResource, operators []transform.UpdateOperator, opts ...func(clean *Clean)) error {
...
func InsertTask(source task.Table, target task.Table, operator transform.InsertOperator, opts ...func(*Insert)) error {
...
func TransferTask(source task.Table, target task.Table, operator transform.TransferOperator) error {
...
func UpdateTransferTask(source task.Table, target task.Table, operators []transform.UpdateOperator) error {
...
func UpdateTask(source task.Table, operators []transform.UpdateOperator) error {
